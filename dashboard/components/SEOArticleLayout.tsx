    ...
    <div className="min-h-screen bg-[#080616] font-sans text-[#E0E4F5] selection:bg-indigo-500/30 overflow-x-hidden relative">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 relative z-10">
        <article className="
          ...
          [&>a]:text-indigo-400 [&>a]:underline [&>a]:font-bold hover:[&>a]:text-indigo-300 [&>a]:transition-colors
        ">
          {children}
        </article>
        ...
        <div className="mt-16 p-8 md:p-10 bg-indigo-600/10 border border-indigo-500/20 rounded-3xl text-center">
          ...
          <Link href="/sign-up?redirect_url=/install" className="inline-block bg-indigo-600 text-white px-8 py-4 rounded-xl font-black text-lg hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(99,102,241,0.25)] transition-all">
